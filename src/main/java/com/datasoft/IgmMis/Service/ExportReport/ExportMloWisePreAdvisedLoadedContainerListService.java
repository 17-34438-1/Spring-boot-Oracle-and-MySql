...
//                ") AS tmp GROUP BY mlo ";
    ...
    public List getMloWisePreadviceViewList(String Rotation,String mlo){
        ...
        List resultList=OracleDbTemplate.query(sqlQuery,new MloWisePreadviceViewList());
...
//                ") AS tmp ";
        ...
        List resultList=OracleDbTemplate.query(sqlQuery,new MloWiseSummary());
